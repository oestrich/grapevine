defmodule Grapevine.Games.ClientSettings do
  ...
  def changeset(struct, params) do
    struct
    |> cast(params, [:character_message, :character_name_path])
  ...
  defp validate_character_message(changeset) do
    ...
    case character_message != nil || character_name_path != nil do
      true ->
        validate_required(changeset, [:character_message, :character_name_path])
